...
class Assistant(Agent):
    ...
    @function_tool
    async def search_life_details(self, context: RunContext, question: str) -> str:
        """Retrieve relevant details from the life.json file about Person using Moss semantic search."""
